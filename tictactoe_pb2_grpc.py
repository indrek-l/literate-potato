...
class TicTacToeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.starting_player = channel.unary_unary(
                ...
                response_deserializer=tictactoe__pb2.StartingPlayerResponse.FromString,
                )
...
def add_TicTacToeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'starting_player': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=tictactoe__pb2.StartingPlayerResponse.SerializeToString,
            ),
...
class TicTacToe(object):
    ...
    def starting_player(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/TicTacToe/starting_player',
            tictactoe__pb2.StartingPlayerMessage.SerializeToString,
            tictactoe__pb2.StartingPlayerResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
